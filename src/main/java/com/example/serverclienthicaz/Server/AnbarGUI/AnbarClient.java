...
public class AnbarClient extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(AnbarClient.class.getResource("/com/example/serverclienthicaz/AnbarFxml/MainMenu.fxml"));
