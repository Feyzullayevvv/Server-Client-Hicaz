...
public class MexaricController {
    ...
    public void initMexaricList(){
        ...
        anbarClient.sendMessage("QUERYMEXARIC");
        mexaricList = (List<Mexaric>) anbarClient.listReader();
    ...
    public void createNewMexaric(){
        try {
            FXMLLoader  loader= new FXMLLoader(getClass().getResource("/com/example/serverclienthicaz/AnbarFxml/NewMexaric.fxml"));
            Pane = loader.load();
            NewMexaricController controller= loader.getController();
    ...
    public void  deleteItem(Mexaric mexaric){
        try {
            ...
            if (result.isPresent() && (result.get() == ButtonType.OK)) {
                anbarClient.sendMessage("DELETMEXARIC");
    ...
    public void createMexaricInfo(MexaricInfoController controller) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/serverclienthicaz/AnbarFxml/MexaricInfo.fxml"));
