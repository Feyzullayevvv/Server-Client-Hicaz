...
public class EmeliyyatInfoDialog {
    @FXML
    ...
    public void init(ProsesClient prosesClient, Emeliyyat emeliyyat){
    ...
    public void populate(){
        prosesClient.sendMessage("GETEMELIYYATINFO");
        prosesClient.sendMessage(String.valueOf(emeliyyat.getNr()));
        emeliyyatItemList.clear();
        emeliyyatItemObservableList.clear();
        emeliyyatItemList=(List<EmeliyyatItem>) prosesClient.objectReader();
    ...
    public void handleClick(MouseEvent event) {
        if (event.getClickCount() == 2) {
            if (emeliyyatTableView.getSelectionModel().getSelectedItem() != null) {
                ...
                fxmlLoader.setLocation(getClass().getResource("/com/example/serverclienthicaz/ProsesFxml/EmeliyyatItemInfoDialog.fxml"));
                try {
                ...
                EmeliyyatItemInfoDialog controller = fxmlLoader.getController();
