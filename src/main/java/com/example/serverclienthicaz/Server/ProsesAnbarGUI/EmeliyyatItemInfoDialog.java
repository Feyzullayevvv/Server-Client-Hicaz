...
public class EmeliyyatItemInfoDialog {
    ...
    public void init(ProsesClient prosesClient, EmeliyyatItem emeliyyatItem){
    ...
    public void populate(){
        ...
        prosesClient.sendMessage(String.valueOf(emeliyyatItem.getReceptNr()));
