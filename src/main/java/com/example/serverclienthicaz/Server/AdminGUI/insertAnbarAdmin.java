...
import com.example.serverclienthicaz.Server.AnbarGUI.AnbarController;
...
public class insertAnbarAdmin {
    ...
    public void handleBitti(){
        ...
        for (AnbarItem anbarItem : anbarItemList){
            client.sendMessage(anbarItem.getMal()+"/"+anbarItem.getCeki()+"/"+anbarItem.getMebleg());
        }
