...
public class TehvilInfoDialogAdmin {
    @FXML
    ...
    public void init(Client client, Tehvil tehvil){
        this.client = client;
        this.tehvil=tehvil;
    ...
    public void populate(){
        ...
        client.sendMessage("GETTEHVININFO");
        client.sendMessage(String.valueOf(tehvil.getNr()));
        tehvilItemsList = (List<TehvilItems>) client.objectReader();
